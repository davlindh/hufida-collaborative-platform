  ...
  return (
    <Card className="bg-deepGreen-50 border-deepGreen-200">
      <CardContent className="p-6">
        ...
        <p className="mb-4 text-deepGreen-700">HUFIDA was founded in 2005 by a group of passionate individuals committed to addressing development challenges in Africa. Since our inception, we have grown from a small local initiative to an international organization with a significant impact across the continent.</p>
        <p className="mb-4 text-deepGreen-700">Key milestones in our journey include:</p>
