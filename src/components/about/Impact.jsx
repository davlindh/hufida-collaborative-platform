  ...
  return (
    <div>
      ...
      <ul className="list-disc pl-5 space-y-2 text-deepGreen-700">
        ...
        <li>Implemented renewable energy solutions in 50 communities</li>
        <li>Reduced waste by 30% in targeted urban areas through our waste management initiatives</li>
      </ul>
    </div>
  );
};
