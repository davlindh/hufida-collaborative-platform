...
export const projectsData = [
  ...
  },
  {
    ...
    activities: [
      ...
      "Digital Archive Creation for cultural artifacts and oral histories"
    ],
    impact: [
      ...
      "Created digital archives for 10,000+ cultural artifacts"
    ],
    getInvolved: [
      ...
      "Help digitize and catalog cultural artifacts"
    ],
    keyFeatures: [
      ...
      "AI-powered translation tools for endangered languages"
    ],
  ...
  },
  {
    ...
    activities: [
      ...
      "Sustainable Energy Implementation in rural areas"
    ],
    impact: [
      ...
      "Installed renewable energy systems in 200 off-grid communities"
    ],
    getInvolved: [
      ...
      "Sponsor a renewable energy project in an off-grid village"
    ],
    keyFeatures: [
      ...
      "Satellite-based wildlife monitoring system"
    ],
  ...
  },
  {
    ...
    activities: [
      ...
      "Technology-enabled Early Warning Systems for natural disasters"
    ],
    impact: [
      ...
      "Implemented early warning systems in 30 disaster-prone areas"
    ],
    getInvolved: [
      ...
      "Sponsor the installation of an early warning system in a vulnerable community"
    ],
    keyFeatures: [
      ...
      "Blockchain-based aid distribution tracking system"
    ],
