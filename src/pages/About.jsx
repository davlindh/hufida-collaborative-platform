...
const About = () => {
  ...
  const sections = [
    ...
    { id: "membership", title: "Membership", icon: <BookOpen className="h-5 w-5" />, content: "Membership is open to any person or entity interested in contributing to our objectives. Applications are addressed to the Management Board. Members can serve as volunteers for the Association." },
  ];

  const detailedSections = [
    { id: "history", title: "Our History", icon: <Globe className="h-6 w-6" /> },
    { id: "impact", title: "Impact and Achievements", icon: <Target className="h-6 w-6" /> },
    { id: "partnerships", title: "Partnerships and Collaborations", icon: <Users className="h-6 w-6" /> },
    { id: "future", title: "Future Goals", icon: <Rocket className="h-6 w-6" /> },
    { id: "team", title: "Our Team and Leadership", icon: <Users className="h-6 w-6" /> },
  ];

  return (
    <div className="min-h-screen bg-gradient-to-b from-deepGreen-800 to-deepGreen-600 text-white p-4 sm:p-8 overflow-y-auto">
