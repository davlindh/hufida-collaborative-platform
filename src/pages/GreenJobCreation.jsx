...
import { sections, features, vision } from '../data/greenJobCreation';

const GreenJobCreation = () => {
...
const ProjectHeader = () => (
  ...
  >
    Green Job Creation and Sustainable Livelihoods
  </motion.h1>
);
...
const GetInvolvedButton = () => (
  ...
  >
    <Tooltip>
      <TooltipTrigger asChild>
        <Button className="w-full">Get Involved in Green Job Creation</Button>
      </TooltipTrigger>
      <TooltipContent>
...
export default GreenJobCreation;